...
#define _MAX_NUMBER_OF_NODES 600
#define _MAX_NUMBER_OF_LINKS 800
#define _MAX_NUMBER_OF_TIME_INTERVALS 150

#define _MAX_NUMBER_OF_VEHICLES 120
#define _MAX_NUMBER_OF_PASSENGERS 200
#define _MAX_NUMBER_OF_SERVED_PASSENGERS 200

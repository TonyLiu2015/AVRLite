...
if __name__=='__main__':
    ...
    os.system(r'"C:\Users\Jiangtao Liu\Desktop\Part_C_Submission_R2\2_Dantzig-Wolfe decomposition\no_capacity_veh_cap_2\Initial_Sub-problems_VRP.exe"')
    g_output_initial_agent_VRP_solution()
    # generate the marginal values
    ws_INI = GamsWorkspace()
    master_problem_INI = ws_INI.add_job_from_file("C:\\Users\\Jiangtao Liu\\Desktop\\Part_C_Submission_R2\\2_Dantzig-Wolfe decomposition\\no_capacity_veh_cap_2\\Vehicle assignment_master.gms")
    ...
    for i in range(2,iteration_number+1):
       ...
       # generate the new solution of sub-problems
        os.system(r'"C:\Users\Jiangtao Liu\Desktop\Part_C_Submission_R2\2_Dantzig-Wolfe decomposition\no_capacity_veh_cap_2\Sub-problems_VRP.exe"')
        ...
        ws = GamsWorkspace()
        master_problem = ws.add_job_from_file("C:\\Users\\Jiangtao Liu\\Desktop\\Part_C_Submission_R2\\2_Dantzig-Wolfe decomposition\\no_capacity_veh_cap_2\\Vehicle assignment_master.gms")
        master_problem.run()
